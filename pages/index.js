      ...
      <div className="blog">
        ...
        <div className="blog-header-container">
          {props.posts.map((item) => {
            return (
              <>
                <div className="blog-header haha" id={item.id}>
                  <div className="blog-article header-article">
                    <div className="blog-big__title">{item.category}</div>
                    <div className="blog-menu small-title date">
                      {item.datePublished}
                    </div>
                  </div>
                  <div className="blog-article">
                    <img src={item.coverImage.url} alt="ss" />
                    <h2>{item.title}</h2>
          ...
          <div className="blog-right">
            <div className="blog-right-container">
              ...
              <div className="blog-right-page-subtitle">
                ...
                introspective lyrics and the albums
              </div>
            </div>
            <div className="blog-right-container">
              <div className="blog-title-date">
            ...
            <div className="blog-right-container">
              ...
              <div className="blog-right-page-title">
                Elon Musk SpaceX is launching a moon satellite
              </div>
              <div className="blog-right-page-subtitle">
                The interior concept was conceived of by Dutch archtitect Studio
                Anne Holtrop who cleverly emulated
            ...
            <div className="circle">
              ...
              <div className="circle-subtitle">
                Don try to be like someone else, be yourself. Be secure with
                yourself.
              </div>
